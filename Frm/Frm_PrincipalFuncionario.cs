...
{
    public partial class Frm_PrincipalFuncionario : Form
    {
        ...
        public Frm_PrincipalFuncionario()
        {
            InitializeComponent();
        }

        private void Frm_PrincipalFuncionario_Load(object sender, EventArgs e)
        {
            listarClientes();
            listarClientes02();
        }
        ...
        private void Btn_AtualizarCarro_Click(object sender, EventArgs e)
        {
            listarClientes();
        }
