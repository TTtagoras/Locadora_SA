...
namespace LocadoraSA.Frm
{
    ...
    { 
        private Clientes funcionario;

    
        public Frm_CadastroCliente(string CPF, string Nome, string Sobrenome, string Senha, string Endereco, string Telefone, string Email, string CNH, string CEP)
        {
            InitializeComponent();
            Txt_Cpf.Text = CPF;
            Txt_Nome.Text = Nome;
