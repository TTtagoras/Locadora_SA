...
{
    public partial class Frm_CadastroAdiministrador : Form
    {

        private Administrador funcionario;


        public Frm_CadastroAdiministrador(string CPF, string Nome, string Sobrenome, string Senha, string Endereco, string Telefone, string Email, string CNH, string CEP)
        {
            InitializeComponent();
            Txt_Cpf.Text = CPF;
            Txt_Nome.Text = Nome;
        ...
        public Frm_CadastroAdiministrador()
        {
            InitializeComponent();
        }
